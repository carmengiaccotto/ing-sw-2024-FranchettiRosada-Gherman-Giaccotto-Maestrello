...
//        showBoardAndPlayAreas(model);
     ...
     * The UserInterface is responsible for the actual display of the colors.
     *
     * @param availableColors A list of PawnColor representing the colors available for the player's pawn.
     * @throws RemoteException if a communication-related exception occurred during the execution of a remote method call
     */
    @Override
