...
/**
 * This class represents an exception that is thrown when there is an error in initializing a game.
...
public class GameInitializationException extends RuntimeException {
    ...
    /**
     * This constructor creates a new GameInitializationException.
     *
