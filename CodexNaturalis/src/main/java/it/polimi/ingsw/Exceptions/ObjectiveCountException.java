...
/**
 * This class represents an exception that is thrown when there is an error related to the count of objectives.
...
public class ObjectiveCountException extends RuntimeException {
    ...
    /**
     * This constructor creates a new ObjectiveCountException.
     *
