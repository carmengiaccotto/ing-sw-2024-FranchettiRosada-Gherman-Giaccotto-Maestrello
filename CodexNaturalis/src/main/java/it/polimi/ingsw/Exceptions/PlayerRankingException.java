...
/**
 * This class represents an exception that is thrown when there is an error related to player ranking.
...
public class PlayerRankingException extends RuntimeException {
    ...
    /**
     * This constructor creates a new PlayerRankingException.
     *
